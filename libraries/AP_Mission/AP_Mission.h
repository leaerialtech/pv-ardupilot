...
private:
    ...
    bool start_command_user_2(const AP_Mission::Mission_Command& cmd);
    bool start_command_user_3(const AP_Mission::Mission_Command& cmd);
