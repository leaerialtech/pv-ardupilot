...
public:
	...
	//PRECISIONVISION
    //storing these as single byte  so they persist
    //this limits the range of values allowed!!
	    struct PACKED User1_Command{
        int8_t  servoNotUsed; //param1;
        int8_t  sprayEnabled;  // param2;
        int8_t  ignoreHeadingChecks; //param3 
    };
	////////////
...
//PRECISIONVISION
    bool start_command_user_1(const AP_Mission::Mission_Command& cmd);
/////////////////
