...
//PRECISIONVISION
    case MAV_CMD_USER_1:
        return start_command_user_1(cmd);
//    case MAV_CMD_USER_2:
//        return start_command_user_2(cmd);
//    case MAV_CMD_USER_3:
//        return start_command_user_3(cmd);
...
//PRECISIONVISION
 case MAV_CMD_USER_1:
        cmd.p1 = packet.param2; //this is NOT a bug -- early on p1 was used to specify a servo #,  param2 is the spray-on/off value and needs to be the "p1" value,
       
        //so only 12 bytes will ever be packed... so we can't sotre all 7 floats
        //we are only using small integer/boolean type values for now
        //at one point I was considering passing the desired heading as a parameter, but I don't believe that was finished.
        cmd.content.user1.servoNotUsed = (int8_t) packet.param1;
        cmd.content.user1.sprayEnabled = (int8_t) packet.param2;
        cmd.content.user1.ignoreHeadingChecks = (int8_t) packet.param3;
        //cmd.content.user1.param4 = packet.param4;
...
//PRECISIONVISION//////////////
case MAV_CMD_USER_1:
        packet.param1 = cmd.content.user1.servoNotUsed; 
        packet.param2 = cmd.content.user1.sprayEnabled; //cmd.p1;
        packet.param3 = cmd.content.user1.ignoreHeadingChecks;
     
        //only 12 bytes get stored down -- see PackedContent
        
        //   packet.param4 = cmd.content.user1.param4;
        //packet.param5 = cmd.content.user1.param5;
        //packet.param6 = cmd.content.user1.param6;
        //packet.param7 = cmd.content.user1.param7; 
...
//         case MAV_CMD_USER_3:
//       packet.param1 = cmd.content.user1.param1; //this is p1 on cmd3 
//        packet.param2 = cmd.content.user1.param2;
//        packet.param3 = cmd.content.user1.param3;
//        packet.param4 = cmd.content.user1.param4;
//        break;
