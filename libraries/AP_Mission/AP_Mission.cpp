...
MAV_MISSION_RESULT AP_Mission::mavlink_int_to_mission_cmd(const mavlink_mission_item_int_t& packet, AP_Mission::Mission_Command& cmd)
{
    ...
    case MAV_CMD_USER_1:
        ...
        cmd.content.user1.param1 = packet.param1;
        cmd.content.user1.param2 = packet.param2;
        cmd.content.user1.param3 = packet.param3;
        cmd.content.user1.param4 = packet.param4;
        cmd.content.user1.param5 = 0;
        cmd.content.user1.param6 = 0;
        cmd.content.user1.param7 = 0; 
    break;
    case MAV_CMD_USER_2:
        cmd.p1 = packet.param2;
        break;
...
bool AP_Mission::mission_cmd_to_mavlink_int(const AP_Mission::Mission_Command& cmd, mavlink_mission_item_int_t& packet)
{
  ...
  //  packet.current = (packet.seq == _nav_cmd.index);
...
bool AP_Mission::is_do_commands_all_done()
{
    return _flags.do_cmd_all_done;
}
