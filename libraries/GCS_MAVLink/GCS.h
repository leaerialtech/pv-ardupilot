...
protected:
   ...
   ///////////////////
   //PrecisionVision//
    MAV_RESULT handle_command_user1(const mavlink_command_int_t &packet);
    MAV_RESULT handle_command_user2(const mavlink_command_int_t &packet);
    MAV_RESULT handle_command_user3(const mavlink_command_int_t &packet); 
	/////////////////
...
///////////////////
//PRECISIONVISION//
typedef struct pv_resume_point_details {
    int current_wp_idx;
    int newMissionSize;
    float lat;
    float lng;
...
//PrecisionVision
    ...
    ObjectArray<pvresume_t> _pv_resumepoint_queue{5};  //PrecsisionVision
	
	//I think we have to do mimic StatusTextQueue 
