...
#define AC_SPRAYER_DEFAULT_HEADING_DELAY    100    ///< must be within valid heading for this time period before sprayer can be enabled
...
//PrecisionVision:
    AP_Float get_swath_width() const { return _swath_width;}
    AP_Float get_heading_interval() const { return _heading_interval;}
...
private:
   ...
   //PV-TODO remove these
   // 
    //int32_t _desired_heading;
   // bool _wait_for_heading_checks;
	///
...
AP_Int16 _spray_door_pwm_desired;  //SPRAY_DOOR_PWM_DESIRED;
    ...
    uint32_t        _heading_within_bounds_time;
