...
public:
    ...
    enum OAPathPlanTypes {
        ...
        OA_PATHPLAN_PRECISIONVISION_STOP =10  //custom for precisinvision by leaaerialtech 
    };


    AP_Int8 getType(){return _type;}
    AP_Float getMargin(){return _margin_max;}
...
private:
   ...
   // AP_OAPrecisionVisionStop *_oapvstop; 
