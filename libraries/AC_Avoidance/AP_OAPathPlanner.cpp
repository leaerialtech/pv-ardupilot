/*
   ...
   GNU General Public License for more detfails.
                                         ...
                                         Location &result_destination)
{
    ...
    //we presently handle this precisionvision code (not really obstacalde ovoidance/pathfinding)
    //outside of this module, just using the parameter. should refactor. 
    if(_type == OA_PATHPLAN_PRECISIONVISION_STOP){
        return OA_NOT_REQUIRED;
    }
