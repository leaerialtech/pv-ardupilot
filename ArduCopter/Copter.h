...
class Copter : public AP_Vehicle, public PVTankSensorDelegate 
{
    public:

    //PrecisionVision
    void handleTankSensorTriggered() override;

    //friend class PrecisionVision::pvmain;
...
public: //temporary
    Mode::Number get_flight_mode_num(){return this->flightmode->mode_number();};
...
#if false  //precisionvision removing as breaking build
//AP_LANDINGGEAR_ENABLED
	...
	//PRECISIONVISION///////
    //PVSprayManager pvspraymgr; //everything is still in AC_Sprayer, need to refactor 
    PVTankSensorManager pvtanksensor;     
   //PV-TODO: 
    ...
    //precisionvision removed preventing build
#if false
//AP_LANDINGGEAR_ENABLED
    // landing_gear.cpp
