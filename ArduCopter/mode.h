...
public:
    ...
    private:
        ...
        uint8_t _mode = AUTO_YAW_LOOK_AHEAD; //AUTO_YAW_LOOK_AT_NEXT_WP;
...
protected:
    ...
    public: 
    //temporarily making this public so that I can use in AC_Sprayer, not sure I 
    //understand code just yet so be careful if you use this elsewhere 
...
//PrecisionVision:
    //the previsouly executing command (not necessarily idx -1, e.g start from mid mission or change wpt)
    //will be null if was not previously executing a mission command
    AP_Mission::Mission_Command* _prevWpNavCmd;
