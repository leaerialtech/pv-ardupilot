...
private:
    ...
    //precisionvision//
    bool _delegate_loiter_active = false; 
    ///
...
public:
	...
	//PrecisionVision modification:
    bool isBrakeMode = false;  //tells loiter if we entered via "brake flight mode" -- ignore stick inputs
	//////////
