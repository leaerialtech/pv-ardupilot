...
//PRECISIONVISION////////////////////////////////
   ...
   // @Param: PVTANK_PIN
    // @DisplayName: PVTANK_PIN
    // @Description: the gpio pin the PrecisionVisino tank sensor is connected to
    // @User: Standard
...
const AP_Param::GroupInfo ParametersG2::var_info2[] = {
    ...
    // <<< OEM ADD: CentralUAS / PrecisionVision OEM subgroup at idx 60 (out of 62 possible)
    // @Group: PV_
    // @Path: (local) ParametersOEM (OEM fork-only parameters)
    AP_SUBGROUPINFO(pvoem, "PV_", 60, ParametersG2, ParametersOEM),
...
//PRECISIONVISION
//we never used old hardware so we don't need to worry about this conversion.  This param was repurposed for PVBattThresh 
